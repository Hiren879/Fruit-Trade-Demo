...
1. Simplest way to run this project is to unzip the folder and import project as "projects from Folder or Archive". Run project simply by running file **TradeEngine.java** as a main program from IDE.
